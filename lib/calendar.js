 ...
 * @param {{ title, date, startTime, endTime, location, description }} event
...
// =====================================================================
// OAuth setup helper — run once to get refresh token
// =====================================================================
/**
 * Generate the auth URL for initial setup.
 * Visit this URL → authorize → get the code → exchange for tokens.
 */
