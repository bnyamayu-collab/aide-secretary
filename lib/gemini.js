 ...
 */
async function chat(systemPrompt, userText, media = [], opts = {}) {
  const key = API_KEY();
 ...
 */
async function describeImage(imageBase64, mime = 'image/jpeg') {
...
module.exports = { chat, describeImage, buildSystemPrompt };
