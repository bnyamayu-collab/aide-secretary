 ...
 */
function confirmMessage(text, yesLabel, yesData, noLabel, noData) {
  return {
    type: 'template',
    altText: text,
    template: {
 ...
 * Flex message card
 */
function flexCard(altText, title, body, buttons = []) {
  const contents = {
    type: 'bubble',
    header: {
...
module.exports = { reply, push, downloadContent, getProfile, confirmMessage, quickReply, flexCard };
